                ...
                if creds and creds.expired and creds.refresh_token:
                    ...
                    if oauth_credentials:
                        ...
                        try:
                            ...
                            # For production, we need to handle the OAuth flow differently
                            print("[WARNING] OAuth requires user interaction")
                            print("[INFO] You need to complete OAuth flow manually")
                            print("[INFO] Visit your app URL to complete authentication")
                            self.service = None
                            return
